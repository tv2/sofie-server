...
export enum SystemActionId {
  ...
  ACTIVATE_RUNDOWN = 'ACTIVATE_RUNDOWN',
  DEACTIVATE_RUNDOWN = 'DEACTIVATE_RUNDOWN',
  ...
  SET_TAKE_MODE_STANDARD = 'SET_TAKE_MODE_STANDARD',
  SET_TAKE_MODE_RECALL = 'SET_TAKE_MODE_RECALL'
}
