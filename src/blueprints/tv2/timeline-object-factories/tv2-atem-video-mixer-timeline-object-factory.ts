...
export class Tv2AtemVideoMixerTimelineObjectFactory implements Tv2VideoMixerTimelineObjectFactory {
  ...
  public createProgramTimelineObject(sourceInput: number, enable: TimelineEnable): AtemMixEffectTimelineObject {
  ...
  public createCleanFeedTimelineObject(sourceInput: number, enable: TimelineEnable): AtemMixEffectTimelineObject {
    return this.createAtemMeTimelineObjectForLayer(
  ...
  private createTransitionEffectTimelineObject(layer: Tv2AtemLayer, meContent: AtemMixEffectWithTransition): AtemMixEffectTimelineObject {
    return {
  ...
  public createMixTransitionEffectTimelineObjects(sourceInput: number, durationInFrames: number): AtemMixEffectTimelineObject[] {
    const meContent: AtemMixEffectWithTransition = {
      type: AtemMixEffectType.TRANSITION,
      input: sourceInput,
  ...
  public createDipTransitionEffectTimelineObjects(sourceInput: number, durationInFrames: number, dipInput: number): AtemMixEffectTimelineObject[] {
    const meContent: AtemMixEffectWithTransition = {
      type: AtemMixEffectType.TRANSITION,
      input: sourceInput,
