...
export class Tv2VideoClipActionFactory {
  ...
  private createInsertVideoClipAsNextAction(configuration: Tv2BlueprintConfiguration, videoClipData: Tv2VideoClipData): Tv2VideoClipAction {
    ...
    return {
      ...
      data: {
        partInterface,
        pieceInterfaces: [
          this.createProgramPieceInterface(configuration, partId, videoClipData, Tv2PieceType.VIDEO_CLIP)
        ]
      },
      metadata: {
  ...
  private createProgramPieceInterface(configuration: Tv2BlueprintConfiguration, partId: string, videoClipData: Tv2VideoClipData, pieceType: Tv2PieceType): PieceInterface {
