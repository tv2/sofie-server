...
export abstract class Tv2BaseGraphicTimelineObjectFactory {
  protected abstract createFullGraphicTimelineObjectContent(blueprintConfiguration: Tv2BlueprintConfiguration, manifest: Tv2GraphicActionManifest): object // Todo: create/find better return type.
  ...
  protected getLayerNameFromGraphicTarget(target: Tv2GraphicsTarget): string {
    switch (target) { // Todo: should the default case be here, throwing an 'UnexpectedCaseException'?
      case Tv2GraphicsTarget.WALL: return Tv2GraphicsLayer.GRAPHIC_WALL
      case Tv2GraphicsTarget.OVL: return Tv2GraphicsLayer.GRAPHIC_OVERLAY_PILOT
