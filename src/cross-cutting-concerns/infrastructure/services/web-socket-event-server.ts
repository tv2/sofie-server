...
} from '../../../tv2-inews-ingest/application/interfaces/i-news-ingest-configuration-event-observer'
import {
  INewsIngestConfigurationEvent
} from '../../../tv2-inews-ingest/application/value-objects/i-news-ingest-configuration-event'
