import { UnexpectedCaseException } from '../exceptions/unexpected-case-exception'
...
export class ExhaustiveCaseChecker {
   ...
   */
  public static assertAllCases(unexpectedCase: never, scenario: string): never {
    // Type guard
    throw new UnexpectedCaseException(unexpectedCase, scenario)
  }
}
