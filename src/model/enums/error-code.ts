export enum ErrorCode {
  ...
  FIRST_PART_IN_SEGMENT = 'FIRST_PART_IN_SEGMENT',
  FIRST_SEGMENT_IN_RUNDOWN = 'FIRST_SEGMENT_IN_RUNDOWN',
  ...
  ALREADY_REHEARSAL = 'ALREADY_REHEARSAL',
  RUNDOWN_IS_THROTTLED = 'RUNDOWN_IS_THROTTLED',
  ...
  TAKE_IS_BLOCKED = 'TAKE_IS_BLOCKED',
