...
import {
  ...
  SegmentUpdatedEvent,
} from '../rundown-execution/application/value-objects/rundown-event'
...
import { MediaCreatedEvent, MediaDeletedEvent, MediaUpdatedEvent } from '../sofie-ingest/application/value-objects/media-event'
...
import { ShelfConfigurationUpdatedEvent } from '../rundown-execution/application/value-objects/configuration-event'
...
} from '../rundown-execution/application/value-objects/device-event'
